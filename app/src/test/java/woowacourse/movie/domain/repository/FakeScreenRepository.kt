...
class FakeScreenRepository : ScreenRepository {
    ...
    companion object {
        val fakeScreen1Data =
            ScreenData(1, FakeMovieRepository.fakeMovie1, DateRange(LocalDate.of(2024, 3, 1), LocalDate.of(2024, 3, 3)))
        val fakeScreen2Data =
            ScreenData(2, FakeMovieRepository.fakeMovie2, DateRange(LocalDate.of(2024, 3, 2), LocalDate.of(2024, 3, 4)))
        val fakeScreen3Data =
            ScreenData(2, FakeMovieRepository.fakeMovie3, DateRange(LocalDate.of(2024, 3, 3), LocalDate.of(2024, 3, 5)))
    }
}
