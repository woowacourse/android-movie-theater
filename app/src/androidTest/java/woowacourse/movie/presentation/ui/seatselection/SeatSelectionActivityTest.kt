...
import woowacourse.movie.presentation.ui.util.getDummyReservationInfo
...
class SeatSelectionActivityTest {
    ...
    private fun performSeatsSelection(action: (context: Context, view: TextView) -> Unit) {
        activityRule.scenario.onActivity { context ->
            val view =
                context.findViewById<TableLayout>(R.id.table_layout_seat_board).children.filterIsInstance<TableRow>()
