...
class MovieDatabaseTest {
    ...
    fun get_screen_movie_Useing_movieId_and_theaterId() {
        ...
        // given
        val screenMovieEntity =
            screeningMovieDao.getByMovieIdAndTheaterId(MovieEntity.STUB.id, MovieTheaterEntity.STUB_A.id)

        // then
        assertThat(screenMovieEntity).isEqualTo(ScreeningMovieEntity.STUB_A)
    }
    ...
    fun get_theaterList_Using_movieId() {
        ...
        val theaters: List<MovieTheaterEntity> = screeningMovieDao.getTheatersByMovieId(MovieEntity.STUB.id)
