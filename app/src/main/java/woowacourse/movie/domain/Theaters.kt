...
//        )
//        val value = listOf(Theater("선릉", Movies.value, mapOf(Title("해리포터와 마법사의 돌") to listOf(LocalTime.of(11,0)))))
//        val value = listOf(
//            Theater(
//                "선릉",
//                movies,
//                mapOf(
//                    Title("해리포터와 불의잔") to listOf(
//                        LocalTime.of(13, 0),
//                        LocalTime.of(15, 0),
//                        LocalTime.of(17, 0),
//                        LocalTime.of(19, 0)
//                    ),
//                    Title("해리포터와 아즈카반의 죄수") to listOf(
//                        LocalTime.of(9, 0),
//                        LocalTime.of(11, 0),
//                        LocalTime.of(15, 0)
//                    )
