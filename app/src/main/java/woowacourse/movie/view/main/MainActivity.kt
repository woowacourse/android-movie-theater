...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var prefsManager: SharedPreferencesStore
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prefsManager = SharedPreferencesStore(this)
        notificationHelper = NotificationPermissionHelper(this, binding.root, this, prefsManager)
