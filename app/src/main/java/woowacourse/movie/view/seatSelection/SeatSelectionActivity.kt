...
class SeatSelectionActivity :
    ...
    private fun getSeatsLayoutColumnCount(): Int = (binding.tlSeatSelection.getChildAt(0) as TableRow).childCount

    private fun setupClickListener() {
        binding.tvSeatSelectionCompleteButton.setOnClickListener {
    ...
    override fun showSeats(seats: List<Seat>) {
        binding.tlSeatSelection.children
    ...
    override fun showButtonEnabled(enabled: Boolean) {
        binding.tvSeatSelectionCompleteButton.isEnabled = enabled
    }
