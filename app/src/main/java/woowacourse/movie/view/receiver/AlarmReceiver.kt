...
class AlarmReceiver : BroadcastReceiver() {
    override fun onReceive(
        ...
        if (ticketId == DEFAULT_TICKET_ID) throw IllegalStateException(INVALID_NOTIFICATION_TICKET_ID)
    ...
    companion object {
        ...
        private const val INVALID_NOTIFICATION_MOVIE_TITLE = "$ALARM_MOVIE_TITLE_KEY is missing in the Intent."
        private const val INVALID_NOTIFICATION_TICKET_ID = "$ALARM_TICKET_ID_KEY is missing in the Intent."
    }
}
