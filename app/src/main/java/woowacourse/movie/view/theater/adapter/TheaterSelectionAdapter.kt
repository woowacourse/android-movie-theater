...
class TheaterSelectionAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TheaterSelectionViewHolder {
    ...
    override fun onBindViewHolder(holder: TheaterSelectionViewHolder, position: Int) {
