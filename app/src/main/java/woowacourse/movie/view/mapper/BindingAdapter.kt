...
fun setDateFormatter(view: TextView, startDate: LocalDate, endDate: LocalDate) {
...
fun setRunningTime(view: TextView, runningTime: RunningTime) {
    view.text = view.context.getString(
...
fun setCinemaName(view: TextView, cinemaName: String) {
    view.text = view.context.getString(
        R.string.cinema,
        cinemaName
    )
...
fun setScreeningItems(view: TextView, size:Int) {
    view.text = view.context.getString(
