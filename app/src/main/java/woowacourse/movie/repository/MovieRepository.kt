    ...
    private val tmpMovies: List<Movie> =
        listOf(
            Movie(
                ...
                title = "해리 포터와 마법사의 돌",
                runningTime = 152,
                screeningDates = ScreeningDates(LocalDate.of(2024, 5, 5), LocalDate.of(2024, 5, 15)),
            ...
            Movie(
                ...
                title = "해리 포터와 비밀의 방",
                runningTime = 162,
                screeningDates = ScreeningDates(LocalDate.of(2024, 5, 5), LocalDate.of(2024, 5, 20)),
            ...
            Movie(
                ...
                runningTime = 141,
                screeningDates = ScreeningDates(LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 25)),
            ...
            Movie(
                ...
                title = "해리 포터와 마법사의 돌",
                runningTime = 152,
                screeningDates = ScreeningDates(LocalDate.of(2024, 5, 1), LocalDate.of(2024, 5, 28)),
                introduction = "해리포터와 마법사의 돌 영화에 대한 설명입니다",
                thumbnail = R.drawable.harry_potter_1,
            ),
        )
