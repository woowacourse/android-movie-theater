...
fun setFormattedLocalDate(view: TextView, startDate: LocalDate, endDate: LocalDate) {
...
fun setFormattedLocalDateTime(view: TextView, localDateTime: LocalDateTime) {
    view.text = localDateTime.toDotFormat()
}

@BindingAdapter("drawableResource")
fun setDrawableResource(view: ImageView, drawableRes: Int) {
    view.setImageResource(drawableRes)
}

@BindingAdapter("seat")
fun setFormattedSeat(view: TextView, seats: List<Seat>) {
     view.text = seats.joinToString(", ") { seat ->
