...
object TheaterMockData {
    val dummyTheaters = listOf(
        Theater(
            ...
            screeningMovies = MovieMockData.movies.toMutableList().subList(1, 5),
            screenTimes = mapOf(
        ...
        Theater(
            name = "선릉 극장",
            screeningMovies = MovieMockData.movies.toMutableList().subList(2, 3),
            screenTimes = mapOf(
        ...
        Theater(
            name = "잠실 극장",
            screeningMovies = MovieMockData.movies.toMutableList().subList(0, 2),
            screenTimes = mapOf(
